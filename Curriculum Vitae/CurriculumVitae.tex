...
\begin{paracol}{2}
  ...
  \cvachievement{\faLaptopCode}{Calculadora de Máximos y Mínimos}{Como proyecto en segundo semestre de universidad creé un {\href{https://github.com/ElKPROOB/Maximos-y-Minimos.git}{\color{blue}programa\color{black}}} para calcular máximos y mínimos de funciones escalares de variable vectorial usando SymPy.}
