...
\begin{paracol}{2}
  ...
  \cvachievement{\faLaptopCode}{Calculator of Max and Min}{As a project in the second semester of university have created a {\href{https://github.com/ElKPROOB/Maximos-y-Minimos.git}{\color{blue}program\color{black}}} to calculate max and min of scalar functions with a vector variable using SymPy.}
